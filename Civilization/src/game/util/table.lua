...
function table.remove_from_list(t, v)
...
require "game/util/datadumper"

--Designed for total loading, so no pointer tables
function table.serialize(t)
	local data = DataDumper(t, nil, true)
